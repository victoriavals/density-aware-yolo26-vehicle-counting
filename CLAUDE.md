...
- P9–P10 belum: counting ByteTrack RQ5 (kit `video_uji/` siap; Naufal sudah menyiapkan 3 klip ±10 mnt — butuh garis virtual + `gt_<nama>.csv` dua penghitung + ambang **A-02/K5** dari pembimbing) → konsolidasi peta placeholder BAB 4 (P10). Sisa eksperimen naskah: bootstrap CI (3.11.5), sensitivitas α V4, ketegaran normalisasi-per-bobot, multi-seed (K6).
