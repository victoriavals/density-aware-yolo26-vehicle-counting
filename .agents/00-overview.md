...
- **Hasil utama (pasca-FASE 1; AP50-95 per kelas×strata, n=24 sel setelah aturan sel-min-30):** H1 V8–V1 p=**0,565** r=+0,140 (tidak signifikan; tetapi selang bootstrap [+0,05; +2,08] pp tak memuat nol — laporkan keduanya); H2 V4–V1 p=**0,208** r=−0,300 (**tidak didukung**, jangan dinarasikan sebagai kecenderungan positif); **H3 V8–V5 p=0,0367 r=+0,487 SIGNIFIKAN** (CI [+1,26; +3,53] pp). Kesimpulan: DALW **komplementer/kondisional** atas HAM+P2, tidak berdiri sendiri. **Memicu A-01** — dan kalimat hasil abstrak v7 harus **ditulis ulang** karena memprasyaratkan kenaikan signifikan atas baseline yang tidak didukung (mAP@0,5 V8 77,97 % < V1 78,61 %). Rincian: `hasil_bab4_5/PETA_PLACEHOLDER_ABSTRAK.md`.
