...
### Diskrepansi dokumen — label GPU: dokumen "RTX 4060" perlu "Ti"

Perangkat aktual adalah **RTX 4060 Ti 8GB** (nama `nvidia-smi`: "NVIDIA GeForce RTX 4060 Ti", terverifikasi 13 Jul 2026). Dokumen **REVISI_PEMBIMBING sudah memperbaiki "RTX 3060" → "RTX 4060" di SEMUA lokasi** (Batasan 1.6, subbab 2.5.2, 2.7.3, 3.6.2, Tabel 3.8) — jadi isu "3060" **sudah tuntas**. Yang tersisa: dokumen menulis "RTX 4060 8GB" **tanpa "Ti"**, sehingga perlu ditambahkan "Ti" agar seragam "RTX 4060 Ti 8GB". Argumen "perangkat kelas menengah" tetap berlaku (VRAM sama-sama 8 GB). Item ini di TODO naskah (CLAUDE.md §10.4) — surface di KB, penyuntingan `.docx` menunggu Naufal.
